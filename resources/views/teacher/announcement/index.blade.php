...
<body class="bg-gray-50 h-screen flex flex-col font-[Inter]">
    ...
    <header class="bg-blue-300 h-16 flex items-center justify-between px-6">
    ...
    <div class="flex flex-1 overflow-hidden">
        <aside class="w-64 bg-gray-50 border-r border-gray-200 pt-4">
            <nav class="flex flex-col">
                ...
                <a href="{{ route('teacher.assignments.create') }}" class="px-6 py-3 font-medium text-sm uppercase hover:bg-gray-200">Create Assignment</a>
                <a href="{{ route('teacher.assignments.index') }}" class="px-6 py-3 font-medium text-sm uppercase hover:bg-gray-200">View Assignment</a>
                <a href="#" class="bg-blue-400 px-6 py-3 font-medium text-sm uppercase">Announcement</a>
            </nav>
        </aside>
